...
const Cart = ({ isOpen }) => {
    ...
    const products = [
...

        {
          ...
          quantity: 1,
          imageSrc: '',
          imageAlt: 'pretty colours and phenethylamine wonders.',
        },
        {
          id: 2,
          name: 'Such drug',
          ...
          imageSrc: '',
          imageAlt:
            'Gets you high, what\'s more to say?.',
        },
      ]
...
const NavLink = ({ href, children }) => {
  return <Link className='mr-10 text-slate-300 hover:text-slate-50 hover:drop-shadow-light-xl transition-all hover:translate-y-[-1.5px] font-mono subpixel-antialiased font-medium select-none leading-none grow-0' href={href}>{children}</Link>
}
