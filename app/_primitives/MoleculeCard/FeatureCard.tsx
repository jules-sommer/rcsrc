...
import { SmilesDrawerWrapper } from "@ui/smilesDrawer/SmilesDrawerWrapper"; // ({ SMILES, theme='dark', height, width, className })
...
export const FeatureCard = ({ name, CAS, smiles, description }) => {
